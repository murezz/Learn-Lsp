...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jan 2021 pada 05.10
...
CREATE TABLE `petugas` (
  ...
  `nama_pertugas` varchar(35) NOT NULL,
...
INSERT INTO `petugas` (`id_petugas`, `username`, `password`, `nama_pertugas`, `level`) VALUES
(1, 'admin', 'admin', 'joko', 'admin'),
(3, 'petugas', 'petugas', 'dadang', 'petugas');
...
('0020481333', '10701', 'Muhammad Reza Aditya', 1, 'Jalan Kebon Pala 3 Tanah abang jakarta Pusat', '085772867820', 1),
('0987908087', '20678', 'brandontken', 2, 'Jalan senoparty jakarta selatan', '087098768585', 1);
...
ALTER TABLE `pembayaran`
  ...
  ADD UNIQUE KEY `id_spp` (`id_spp`,`jumlah_bayar`),
...
ALTER TABLE `spp`
  ...
  ADD UNIQUE KEY `tahun` (`tahun`,`nominal`);
